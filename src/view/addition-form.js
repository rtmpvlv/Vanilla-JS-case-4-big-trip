...
const createAdditionFormTemplate = (tripPoint) => {
  ...
  const dateThen = dayjs().add(1, 'day').format('DD/MM/YY HH:mm');
      ...
      <form class="event event--edit" action="#" method="post">
        <header class="event__header">
          ...
          <div class="event__field-group  event__field-group--time">
            ...
            <input class="event__input  event__input--time" id="event-end-time-1" type="text" name="event-end-time" value="${dateThen}">
          </div>
